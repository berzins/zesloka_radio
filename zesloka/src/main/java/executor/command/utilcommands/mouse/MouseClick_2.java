...
public class MouseClick_2 extends MouseClick {
    ...
    @Override protected void init() {
        ...
        this.add(press);
        this.add(release);
        this.addParam(CommandParams.createParamKey(press, RobotCommand.KEY_EVENT), MOUSE_2_DOWN);
        this.addParam(CommandParams.createParamKey(release, RobotCommand.KEY_EVENT), MOUSE_2_UP);
        this.setFinal(true);
    }
}
